...
export default function Home() {
  return (
    <main>
      ...
      <ul>
        <li className="text-2xl hover:underline hover:text-green-500"><Link href="./week-2/">Week 2 Assignment</Link></li>
        <li className="text-2xl hover:underline hover:text-green-500"><Link href="./week-3/">Week 3 Assignment</Link></li>
        ...
        <li className="text-2xl hover:underline hover:text-green-500"><Link href="./week-9/">Week 9 Assignment</Link></li>
        <li className="text-2xl hover:underline hover:text-green-500"><Link href="./week-10/">Week 10 Assignment</Link></li>
      </ul>
    </main>
  );
}
